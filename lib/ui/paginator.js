...
export class Paginator extends HTMLElement {
    ...
    constructor() {
        ...
        this.addEventListener('touchstart', this.#handleTouchStart.bind(this), opts)
        this.addEventListener('touchmove', this.#handleTouchMove.bind(this), opts)
        this.addEventListener('touchend', this.#handleTouchEnd.bind(this))
        this.addEventListener('load', ({ detail: { doc } }) => {
            doc.addEventListener('touchstart', this.#handleTouchStart.bind(this), opts)
            doc.addEventListener('touchmove', this.#handleTouchMove.bind(this), opts)
            doc.addEventListener('touchend', this.#handleTouchEnd.bind(this))
        })
